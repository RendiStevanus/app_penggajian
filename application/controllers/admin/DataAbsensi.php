...
class DataAbsensi extends CI_Controller
{
  public function index()
  {
    ...
    $data['absensi'] = $this->db->query("SELECT data_kehadiran.*, data_pegawai.nama_pegawai, data_pegawai.jenis_kelamin, data_jabatan.nama_jabatan as jabatan
    FROM data_kehadiran 
    LEFT JOIN data_pegawai ON data_kehadiran.nik=data_pegawai.nik
    LEFT JOIN data_jabatan ON data_pegawai.jabatan=data_jabatan.id_jabatan
